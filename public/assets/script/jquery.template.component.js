...
(function ($, doc, win)
{
                ...
                new Waypoint(
                        {
                            ...
                            handler: function ()
                            {
                                ...
                                if (object.hasClass('template-state-complete'))
                                    return;
    ...
    var templateGoToTop = function (object, option)
    {
        ...
        this.build = function ()
        {
            ...
            $(window).on('hashchange', function (e)
            {
                ...
                if (hash === 'go-to-top')
                    $.scrollTo(0, {duration: 500, easing: 'easeInOutCubic', onAfter: function () {
                    ...
                    new Waypoint(
                            {
                                ...
                                handler: function (direction)
                                {
                                    ...
                                    } else
                                    {
                                        ...
                                        if (parseInt(prevPage.length, 10) === 1)
                                            $self.setSelectedTo(prevPage);
                                    }
                                }
                            });
                }
    ...
    var templateNotice = function (object, option)
    {
        ...
        this.build = function ()
        {
            ...
            if ((close.length === 0) && (timeline.length === 0))
                return;
        ...
        this.setAccordionResposnive = function (bind)
        {
            ...
            $this.find('.template-component-zaccordion-caption-box').each(function ()
            {
                if ($(this).actual('outerHeight') > height)
                    ...
                    $(this).removeClass('template-state-hidden');
            });
